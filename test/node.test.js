...
test('returns true for Firefox 65', t => {
  t.true(supportsDateInput(
    'Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:65.0) Gecko/20100101 Firefox/65.0'
  ))
})

test('returns false for Firefox 54', t => {
  t.false(supportsDateInput(
...
test('returns true for Opera 12', t => {
  t.true(supportsDateInput(
    'Opera/9.80 (Windows NT 6.1; WOW64) Presto/2.12.388 Version/12.18'
  ))
})

test('returns false for Opera 8', t => {
  t.false(supportsDateInput(
    'Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1; en) Opera 8.02'
  ))
})

test('returns true for iOS Safari 11', t => {
  t.true(supportsDateInput(
...
test('returns false for iOS Safari 4', t => {
  t.false(supportsDateInput(
    'Mozilla/5.0 (iPhone; U; CPU iPhone OS 4_0 like Mac OS X; en-us) AppleWebKit/532.9 (KHTML, like Gecko) Version/4.0.5 Mobile/8A293 Safari/6531.22.7'
  ))
})

test('returns true for Android Browser 4', t => {
  t.true(supportsDateInput(
    'Mozilla/5.0 (Linux; U; Android 2.2) AppleWebKit/533.1 (KHTML, like Gecko) Version/4.0 Mobile Safari/533.1'
  ))
})

test('returns true for Android Chrome 63', t => {
  t.true(supportsDateInput(
